...
import org.ohmage.condition.conjunction.Conjunction;
...
public abstract class Fragment {
    ...
    public static interface Builder<T extends Fragment> {
        ...
        /**
         * Builds the {@link org.ohmage.condition.Fragment} to which this builder is associated.
         *
         * @return The validated {@link org.ohmage.condition.Fragment} tree element.
         *
         * @throws InvalidArgumentException
     ...
     *
     * @param surveyItems
     *        A map of survey item IDs to their {@link Prompt} object of
     *        the survey items that have already been validated.
     *
     * @throws InvalidArgumentException
     *         The condition is invalid.
     */
    public abstract void validate(final Map<String, Prompt> surveyItems)
        throws InvalidArgumentException;
