...
public class CompatPositionScroller implements Runnable {
    ...
    public CompatPositionScroller(ListView listView) {
        mList = listView;
        ...
        switch (mMode) {
            case MOVE_DOWN_POS: {
                ...
                final int extraScroll =
                        lastPos < mList.getCount() - 1 ? mExtraScroll : mList.getPaddingBottom();
