 ...
 */
public class PlusClientFragment extends Fragment
    ...
    public static PlusClientFragment getPlusClientFragment(
        ...
        return getPlusClientFragment(activity, AuthUtil.Google.SCOPES, visibleActivities);
    }
...
//        }
    ...
    public static final class ProgressDialogFragment extends DialogFragment {
        ...
        public static ProgressDialogFragment create() {
            return create(R.string.google_progress_message);
        }
